...
namespace sm {
    inline namespace sourcemod {
        inline namespace usermessages {
            namespace detail {
                inline void HudText(IRecipientFilter& crf, const hud_text_parms& textparms, const char* pMessage) {
                ...
                inline void ShakeScreen(IRecipientFilter& crf, float flAmplitude, float flFrequency, float flDurationTime)
                {
#if SOURCE_ENGINE == SE_CSGO
                 ...
                 **/
                inline void FadeScreen(IRecipientFilter& crf, int iDuration, int iHoldTime, int iFlags, Color color)
                {
#if SOURCE_ENGINE == SE_CSGO
                ...
                inline void SayText(IRecipientFilter& crf, int ent_idx, const char* msg, bool chat)
                {
                ...
                inline void HintText(IRecipientFilter& crf, bool hasColor, const char* pMessage)
                {
                    if (hasColor)
                    {
                ...
                inline void SayText2(IRecipientFilter& crf, int ent_idx, bool chat, const char* pMessage)
                {
                ...
                inline void ConstructHintTextAttribute(IRecipientFilter& crf, const char* message)
                {
